    ...
    return (
        ...
        <div className="px-4 sm:w-2/3 lg:w-1/2 mx-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                />
                <button type="submit" className="w-full px-6 py-3 bg-blue-500 text-white font-medium uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-500 focus:outline-none focus:ring-0 active:bg-blue-600">Submit</button>
                </form>
            </div>
            </div>
        </div>
