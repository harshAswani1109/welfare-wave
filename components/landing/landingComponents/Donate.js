...
import qr_side from "../../../public/qr_side.jpg";

const Donate = () => {
  return (
    <div
      className="flex flex-col w-full items-center my-10 md:mt-14 md:mb-20"
      id="donate"
    >
      <div className="flex flex-col md:flex-row pt-10 justify-center items-center">
        <div className="w-full sm:w-6/12 md:w-4/12 flex justify-center items-center ">
          <Image src={qr_side} alt="" className="w-8/12 lg:w-11/12" />
        </div>
